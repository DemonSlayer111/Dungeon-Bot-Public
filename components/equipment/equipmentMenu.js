...
module.exports = {
	...
	execute(interaction) {
        ...
        const embedPump = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedShotgun = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedCompound = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedPike = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedSword = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedSkillet = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedSymbiote = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedFrog = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedAssault = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedShield = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedFlak = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedRiot = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedGhillie = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedFur = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedTekRifle = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedTekShield = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        const embedTekArmor = new MessageEmbed()
        .setColor('#0e48b8')
        ...
        switch(interaction.values[0]){
            case 'pump':
                interaction.update({embeds: [embedPump]})
            break;

            case 'shotgun':
                interaction.update({embeds: [embedShotgun]})
            break;

            case 'compound':
                interaction.update({embeds: [embedCompound]})
            break;

            case "pike":
                interaction.update({embeds: [embedPike]})
            break;

            case 'sword':
                interaction.update({embeds: [embedSword]})
            break;
        
            case 'skillet':
                interaction.update({embeds: [embedSkillet]})
            break;

            case 'symbiote':
                interaction.update({embeds: [embedSymbiote]})
            break;

            case 'frog':
                interaction.update({embeds: [embedFrog]})
            break;

            case 'assault':
                interaction.update({embeds: [embedAssault]})
            break;

            case 'shield':
                interaction.update({embeds: [embedShield]})
            break;

            case 'flak':
                interaction.update({embeds: [embedFlak]})
            break;

            case 'riot':
                interaction.update({embeds: [embedRiot]})
            break;

            case 'ghillie':
                interaction.update({embeds: [embedGhillie]})
            break;

            case 'fur':
                interaction.update({embeds: [embedFur]})
            break;

            case 'tekrifle':
                interaction.update({embeds: [embedTekRifle]})  
            break;

            case 'tekshield':
                interaction.update({embeds: [embedTekShield]})  
            break;

            case 'tekarmor':
                interaction.update({embeds: [embedTekArmor]})  
            break;
        }
