...
module.exports = {
	...
	async execute(message, args) {
        ...
        const prefix2 = (() => {
            ...
            switch(args[0]){
                case "prefix":
                    return message.channel.send({embeds: [newEmbedPrefix]});
                break;
                ...
                case "dungeon":
                    return message.channel.send({embeds:[newEmbedDungeon]});
                break;
    
                case "consumable":
                    return message.channel.send({embeds:[newEmbedConsumable]});
                break;
                ...
                case "boss":
                    return message.channel.send({embeds:[newEmbedBoss]});
                break;
    
                case "traps":
                    return message.channel.send({embeds:[newEmbedTraps]});
                break;
                ...
                case "wall":
                    return message.channel.send({embeds:[newEmbedWall]});
                break;
    
                case "jump":
                    return message.channel.send({embeds:[newEmbedJump]});
                break;
    
                case "axe":
                    return message.channel.send({embeds:[newEmbedAxe]});
                break;
    
                case "threatroom":
                    return message.channel.send({embeds:[newEmbedThreatRoom]});
                break;
                ...
                case 'equipment':
                    return message.channel.send({embeds: [newEmbedEquipment]})
                break;

                case 'cave':
                    return message.channel.send({embeds: [newEmbedCave]})
                break;
    
                case 'artifact':
                    return message.channel.send({embeds: [newEmbedArtifact]})
                break;
                default: return message.channel.send({embeds:[newEmbed]});
            }
