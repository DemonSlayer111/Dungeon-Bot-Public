...
module.exports = {
	name: 'equipment',
    aliases: ['kit', 'gear'],
	description: 'Get information about ARK equipment',
    async execute(message, args) {
        ...
        switch(args[0]){
            case 'pump':
                msg = await message.channel.send({embeds: [embedPump], components: [equipmentRow]})
            break;

            case 'shotgun':
                msg = await message.channel.send({embeds: [embedShotgun], components: [equipmentRow]})
            break;

            case 'compound':
                msg = await message.channel.send({embeds: [embedCompound], components: [equipmentRow]})
            break;

            case "pike":
                msg = await message.channel.send({embeds: [embedPike], components: [equipmentRow]})
            break;

            case 'sword':
                msg = await message.channel.send({embeds: [embedSword], components: [equipmentRow]})
            break;
        
            case 'skillet':
                msg = await message.channel.send({embeds: [embedSkillet], components: [equipmentRow]})
            break;

            case 'symbiote':
                msg = await message.channel.send({embeds: [embedSymbiote], components: [equipmentRow]})
            break;

            case 'frog':
                msg = await message.channel.send({embeds: [embedFrog], components: [equipmentRow]})
            break;

            case 'assault':
                msg = await message.channel.send({embeds: [embedAssault], components: [equipmentRow]})
            break;

            case 'shield':
                msg = await message.channel.send({embeds: [embedShield], components: [equipmentRow]})
            break;

            case 'flak':
                msg = await message.channel.send({embeds: [embedFlak], components: [equipmentRow]})
            break;

            case 'riot':
                msg = await message.channel.send({embeds: [embedRiot], components: [equipmentRow]})
            break;

            case 'ghillie':
                msg = await message.channel.send({embeds: [embedGhillie], components: [equipmentRow]})
            break;

            case 'fur':
                msg = await message.channel.send({embeds: [embedFur], components: [equipmentRow]})
            break;

            case 'tekrifle':
                msg = await message.channel.send({embeds: [embedTekRifle], components: [equipmentRow]})  
            break;

            case 'tekshield':
                msg = await message.channel.send({embeds: [embedTekShield], components: [equipmentRow]})  
            break;

            case 'tekarmor':
                msg = await message.channel.send({embeds: [embedTekArmor], components: [equipmentRow]})  
            break;
            default:
                msg = await message.channel.send({embeds: [embed], components: [equipmentRow]})
        }
