...
module.exports = {
    ...
    async execute(message, args) {
        ...
        switch(args[0]){
            case 'south':
                msg = await message.channel.send({embeds: [embedSouth], components: [caveRow, southRow]})
            break;
            case "central":
                msg = await message.channel.send({embeds: [embedCentral], components: [caveRow, centralRow]})
            break;
            case 'lava':
                msg = await message.channel.send({embeds: [embedLava], components: [caveRow, lavaRow]})
            break;
            case 'northwest':
                msg = await message.channel.send({embeds: [embedNorthwest], components: [caveRow, northwestRow]})
            break;
            case 'yeti':
                msg = await message.channel.send({embeds: [embedYeti], components: [caveRow, yetiRow]})
            break;
            case 'swamp':
                msg = await message.channel.send({embeds: [embedSwamp], components: [caveRow, swampRow]})
            break;
            default:
                msg = await message.channel.send({embeds: [embed], components: [caveRow]})
        }
