...
module.exports = {
    ...
    async execute(message, args) {
        ...
        switch(args[0]) {
            case 'hunter':
                msg = await message.channel.send({embeds: [embedHunter], components: [artifactRow, hunterRow]})
            break;
            case 'clever':
                msg = await message.channel.send({embeds: [embedClever], components: [artifactRow, cleverRow]})
            break;
            case 'massive':
                msg = await message.channel.send({embeds: [embedMassive], components: [artifactRow, massiveRow]})
            break;
            case 'skylord':
                msg = await message.channel.send({embeds: [embedSkylord], components: [artifactRow, skylordRow]})
            break;
            case 'strong':
                msg = await message.channel.send({embeds: [embedStrong], components: [artifactRow, strongRow]})
            break;
            case 'immune':
                msg = await message.channel.send({embeds: [embedImmune], components: [artifactRow, immuneRow]})
            break;
            default: 
                msg = await message.channel.send({embeds: [embed], components: [artifactRow]})
        }
