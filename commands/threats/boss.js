...
module.exports = {
	...
	async execute(message, args) {
        ...
        switch(args[0]){
            case "monkey":
                msg = await message.channel.send({ embeds: [newEmbedMonkey], components: [bossRow]}) 
            break;
            ...
            case "megapithecus":
                if(!args[1]) msg = await message.channel.send({ embeds: [newEmbedMonkey], components: [bossRow]}) 
                if(args[1] === 'pestis') msg = await message.channel.send({ embeds: [newEmbedMonkey], components: [bossRow]}) 
            break;
    
            case "spider":
                msg = await message.channel.send({ embeds: [newEmbedSpider], components: [bossRow]}) 
            break;
            ...
            break;
            case "frog":
                msg = await message.channel.send({ embeds: [newEmbedFrog], components: [bossRow]}) 
            break;
            ...
            case "jelly":
                msg = await message.channel.send({ embeds: [newEmbedCubozoa], components: [bossRow]}) 
            break;
            ...
            case "cubuzoa":
                if(!args[1]) msg = await message.channel.send({ embeds: [newEmbedCubozoa], components: [bossRow]}) 
                if(args[1] === 'multis') msg = await message.channel.send({ embeds: [newEmbedCubozoa], components: [bossRow]}) 
            break;
            ...
            case "chali":
                msg = await message.channel.send({ embeds: [newEmbedChali], components: [bossRow]}) 
            break;
            ...
            case "dodo":
                msg = await message.channel.send({ embeds: [newEmbedDodo], components: [bossRow]}) 
            break;
            ...
            case "doed":
                msg = await message.channel.send({ embeds: [newEmbedDoed], components: [bossRow]}) 
            break;
            ...
            case "doedicurus":
                if(!args[1]) msg = await message.channel.send({ embeds: [newEmbedDoed], components: [bossRow]}) 
                if(args[1] === 'vastus') msg = await message.channel.send({ embeds: [newEmbedDoed], components: [bossRow]}) 
            break;
    
            case "beetle":
                msg = await message.channel.send({ embeds: [newEmbedGula], components: [bossRow]}) 
            break;
    
            case "gula":
                if(!args[1]) msg = await message.channel.send({ embeds: [newEmbedGula], components: [bossRow]}) 
                if(args[1] === 'beetle') msg = await message.channel.send({ embeds: [newEmbedGula], components: [bossRow]}) 
            break;
    
            case "argentustus":
                msg = await message.channel.send({ embeds: [newEmbedArgy], components: [bossRow]}) 
            break;
            ...
            case "noctis":
                msg = await message.channel.send({embeds: [newEmbedNoctis], components: [bossRow]}) 
            break;
            
            default: 
                msg = await message.channel.send({embeds: [newEmbed], components: [bossRow]}) 
