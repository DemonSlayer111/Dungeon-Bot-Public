...
module.exports = {
    ...
    if(!wikiText.query) return interaction.reply({embeds: [new Discord.MessageEmbed().setColor('#0e48b8').setDescription("Unable to find a matching article. Please provide a different search term.")], ephemeral: true})
