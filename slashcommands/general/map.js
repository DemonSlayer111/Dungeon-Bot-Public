...
module.exports = {
    ...
    async execute(interaction) {
        ...
        switch (interaction.options._hoistedOptions[0]?.value) {
            case '1':
                msg = await interaction.reply({ embeds: [embed1], components: [rowMenu], fetchReply: true });
                break;

            case '2':
                msg = await interaction.reply({ embeds: [embed2], components: [rowMenu], fetchReply: true });
                break;

            case '3':
                msg = await interaction.reply({ embeds: [embed3], components: [rowMenu], fetchReply: true });
                break;

            case '4':
                msg = await interaction.reply({ embeds: [embed4], components: [rowMenu], fetchReply: true });
                break;

            case '5':
                msg = await interaction.reply({ embeds: [embed5], components: [rowMenu], fetchReply: true });
                break;

            case '6':
                msg = await interaction.reply({ embeds: [embed6], components: [rowMenu], fetchReply: true });
                break;

            case '7':
                msg = await interaction.reply({ embeds: [embed7], components: [rowMenu], fetchReply: true });
                break;

            default:
                msg = await interaction.reply({ embeds: [embed], components: [rowMenu], fetchReply: true });
        }
